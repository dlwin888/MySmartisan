							...
							<div>
								...
								<div class="params-colors">
									<ul class="colors-list">
										<li v-for="sku in item.sku_info" :key="sku.sku_id"><a href="javascript:;" class="active1" :title="sku.spec_json.show_name"><img :src="'http://img01.smartisanos.cn/'+sku.spec_json.image+'20X20.jpg'"></a></li>
									</ul>
								</div>
